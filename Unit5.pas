...
var
  FrmPrincipalafwe: TFrmPrincipalafwe;
...
procedure TFrmPrincipalafwe.AddFavoritos(Sender: TObject);
begin
  var
    AId: string;
  begin
...
procedure TFrmPrincipalafwe.CarregarListaProdutos(id: integer; nome, descricao: string;
  valor: double);
var
...
function TFrmPrincipalafwe.favorito(id: integer): boolean;
begin
...
procedure TFrmPrincipalafwe.FormCreate(Sender: TObject);
begin
  ChangeTabAction1.Execute;
  GetProdutosBase;
end;

procedure TFrmPrincipalafwe.GetProdutosBase;
begin
...
procedure TFrmPrincipalafwe.Layout1Click(Sender: TObject);
begin
